...
{
    //public class LocalFileSystemFileLoaderConfig
    //{
    //    private const string IGNORE_FILE_PARAM_NAME = "ignore";

    //    public List<string> Ignore { get; }

    //    public LocalFileSystemFileLoaderConfig(IEnumerable<string> ignore)
    //    {
    //        Ignore = ignore?.ToList() ?? new List<string>();
    //    }

    //    public LocalFileSystemFileLoaderConfig(IConfiguration conf) 
